...
import { Menu, X, Moon, Sun, Mail, Phone, MapPin, Github, Linkedin, Send, ExternalLink, Code2, Briefcase, Award } from 'lucide-react';
    ...
    <div className={`${bgClass} min-h-screen transition-colors duration-300`}>
          ...
          <div className="space-y-6">
            ...
            <div className={`${cardBgClass} rounded-2xl p-6 md:p-8 hover:border-pink-400/60 transition-all duration-300 group`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                ...
                <span className={`${darkMode ? 'text-slate-400' : 'text-slate-600'} text-sm md:text-base`}>Ago 2023 - Ene 2024</span>
              </div>
              <p className={`${darkMode ? 'text-slate-300' : 'text-slate-700'} mb-4 leading-relaxed`}>
                Desarrollé aplicaciones web con Angular 16, 17 y 18 para plataformas internas de sistemas administrativos. Incluye gestión de permisos, administración de datos, consultas y generación de reportes. Trabajé con equipos multidisciplinarios en ambientes ágiles.
              </p>
            ...
            <div className={`${cardBgClass} rounded-2xl p-6 md:p-8 hover:border-cyan-400/60 transition-all duration-300`}>
              <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                <div>
                  <h4 className={`text-xl md:text-2xl font-bold ${darkMode ? 'text-pink-400' : 'text-pink-600'} mb-2`}>Full Stack Developer</h4>
                  <p className={`${darkMode ? 'text-cyan-400' : 'text-cyan-600'} text-lg font-semibold`}>U-Pay Company S.A.</p>
                </div>
                <span className={`${darkMode ? 'text-slate-400' : 'text-slate-600'} text-sm md:text-base`}>2021 - 2023</span>
              </div>
              <p className={`${darkMode ? 'text-slate-300' : 'text-slate-700'} mb-4 leading-relaxed`}>
              ...
              <div className="flex flex-wrap gap-2">
                {['Angular', 'Mobile Dev', 'Payment Systems', 'TypeScript', 'Agile/Scrum'].map((tech, i) => (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className={`${cardBgClass} rounded-2xl p-8 border-l-4 ${darkMode ? 'border-pink-500' : 'border-pink-600'}`}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h5 className={`font-semibold mb-2 ${darkMode ? 'text-cyan-400' : 'text-cyan-600'}`}>Ingeniería en Computación</h5>
                <p className={`${darkMode ? 'text-slate-400' : 'text-slate-600'}`}>Instituto San Sebastián | 2017 - 2022</p>
              </div>
              <div>
      ...
      <section id="contacto" className="py-20 px-4 relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className={`${cardBgClass} rounded-2xl p-6 hover:border-cyan-400/60 transition-all cursor-pointer group`}>
              <div className={`p-3 rounded-lg w-fit mb-4 ${darkMode ? 'bg-cyan-500/20' : 'bg-cyan-300/20'}`}>
                <Github className={`${darkMode ? 'text-cyan-400' : 'text-cyan-600'}`} size={24} />
              </div>
              <h4 className={`font-semibold mb-2 ${darkMode ? 'text-cyan-400' : 'text-cyan-600'}`}>GitHub</h4>
              <p className={`${darkMode ? 'text-slate-400 group-hover:text-cyan-400' : 'text-slate-600 group-hover:text-cyan-600'}`}>@pamelaveradev</p>
            </a>
          </div>
      ...
      <footer className={`border-t ${darkMode ? 'border-purple-500/20 text-slate-400' : 'border-purple-300/30 text-slate-600'} py-8 px-4 relative z-10`}>
        <div className="max-w-6xl mx-auto text-center">
          <p>© 2024 Pamela Vera. Desarrollado con React + Tailwind CSS</p>
